...
class GoodsChannel(BaseModel):
    ...
    category = models.ForeignKey(GoodsCategory,
    	on_delete=models.CASCADE, verbose_name='一级商品类别')
...
class SpecificationOption(BaseModel):
    ...
    规格选项
    """
    spec = models.ForeignKey(GoodsSpecification, on_delete=models.CASCADE,
    	verbose_name='规格')
...
class SKUSpecification(BaseModel):
    ...
    """
    sku = models.ForeignKey(SKU, on_delete=models.CASCADE, verbose_name='sku')
    spec = models.ForeignKey(GoodsSpecification, on_delete=models.PROTECT,
    	verbose_name='规格名称')
